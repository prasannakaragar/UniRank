...
function getGhRankColor(rank = '') {
  return GH_RANK_COLORS[rank] || '#9090a8'
}
              ...
              <thead>
                <tr className="bg-gray-50/50">
                  ...
                  {type === 'cp' ? (
                    ...
                    <>
                      <th className="table-header text-left">GITHUB</th>
                          ...
                          <td className="px-4 py-4 text-left">
                            <div className="flex flex-col gap-1 items-start">
                              {entry.github_username ? (
                                <a href={`https://github.com/${entry.github_username}`}
                                   target="_blank" rel="noreferrer"
                                   className="text-[13px] font-bold text-[#6366f1] hover:underline inline-flex items-center gap-1.5 transition-colors">
                                ...
                                <a href={entry.github_url} target="_blank" rel="noreferrer"
                                   className="text-[13px] font-bold text-[#6366f1] hover:underline inline-flex items-center gap-1.5 transition-colors" title={entry.github_review_reason}>
                                  Profile ↗
                                </a>
                              ) : (
                              ...
                              {entry.github_rank && (
                                <span style={{
                                  background: `${getGhRankColor(entry.github_rank)}15`,
                                  border: `1px solid ${getGhRankColor(entry.github_rank)}35`,
                                  color: getGhRankColor(entry.github_rank),
                                  borderRadius: 10,
                                  padding: '1px 8px',
                                  fontSize: '9px',
                                  fontWeight: 800,
